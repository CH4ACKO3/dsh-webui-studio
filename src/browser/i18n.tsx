...
const messages = {
  ...
  elementSourceSaved: {
    en: 'Saved defaults in {count} source file(s) and reloaded Preview.',
    'zh-CN': '已将默认值保存到 {count} 个源码文件并热重载 Preview。',
  },
  ...
  materializedTargets: { en: 'Current Preview Patch targets', 'zh-CN': '当前 Preview 已加载的 Patch 目标' },
  materializedTargetsEmpty: { en: 'Preview has not loaded any Patch target yet. Open the relevant WebUI surface first.', 'zh-CN': 'Preview 尚未加载任何 Patch 目标，请先打开相关的 WebUI 界面。' },
  targetPlugin: { en: 'Target plugin', 'zh-CN': '目标插件' },
  sourcePlugin: { en: 'Source plugin', 'zh-CN': '来源插件' },
  targetPluginCount: { en: '{count} target plugins', 'zh-CN': '{count} 个目标插件' },
  sourcePluginCount: { en: '{count} source plugins', 'zh-CN': '{count} 个来源插件' },
  targetFileCount: { en: '{count} target files', 'zh-CN': '{count} 个目标文件' },
  patchStepCount: { en: '{count} Patch steps', 'zh-CN': '{count} 个 Patch step' },
  noAppliedPatchSteps: { en: 'No applied Patch steps', 'zh-CN': '暂无已应用的 Patch step' },
