...
const messages = {
  ...
  pluginManagementTitle: { en: 'Preview plugins', 'zh-CN': 'Preview 插件' },
  pluginManagementDescription: {
    en: 'Select, enable, disable, or reorder every plugin in the active Draft Preview.',
    'zh-CN': '选择、启停或排序当前 Draft Preview 中的全部插件。',
  },
  ...
  agentTitle: { en: 'DSH Agent', 'zh-CN': 'DSH Agent' },
  ...
  agentScope: { en: 'Studio mode temporarily limits this DSH session to Selection, Harmony inspection, Draft files, build, and preview tools.', 'zh-CN': 'Studio 模式会临时把这个 DSH 会话限制在 Selection、Harmony inspection、Draft 文件和构建预览工具内。' },
  agentStudioMode: { en: 'Studio tools active', 'zh-CN': 'Studio 工具已挂载' },
  agentNoSession: { en: 'No DSH session', 'zh-CN': '尚未连接 DSH 会话' },
  ...
  agentAttachDescription: { en: 'History and identity stay intact. Studio tools, skill, and Draft context are added once for this mode.', 'zh-CN': '历史和会话身份保持不变；本次模式只挂载一次 Studio 工具、Skill 与 Draft 上下文。' },
  ...
  agentStartHint: { en: 'Start or attach a DSH session first', 'zh-CN': '请先新建或接入 DSH 会话' },
