...
const messages = {
  ...
  pluginManagementTitle: { en: 'Harmony plugin providers', 'zh-CN': 'Harmony 插件 Provider' },
  pluginManagementDescription: {
    en: 'Select, enable, disable, or reorder providers in the active Draft Preview.',
    'zh-CN': '选择、启停或排序当前 Draft Preview 中的 Provider。',
  },
  pluginManagementSearch: { en: 'Search plugin providers', 'zh-CN': '搜索插件 Provider' },
  pluginManagementNoResults: { en: 'No plugin providers match this search.', 'zh-CN': '没有匹配当前搜索的插件 Provider。' },
  ...
  patchManagementDraftClosed: { en: 'Open a Draft to inspect its Preview Patches.', 'zh-CN': '打开一个 Draft 后可查看其 Preview Patch。' },
  ...
  profileDraftNotRunningDescription: {
    en: 'Start this Draft instance before managing its isolated plugin and Patch profile.',
    'zh-CN': '启动当前 Draft 实例后，才能管理其隔离的插件与 Patch 配置。',
  },
  ...
  automaticPatchContentUnavailable: {
    ...
    'zh-CN': '内容 Patch 需要非空原文本，并且替换文本必须不同。',
  },
