...
const messages = {
  ...
  pluginInventoryTitle: { en: 'Loaded plugins', 'zh-CN': '已加载插件' },
  pluginInventoryDescription: {
    en: 'Inspect the stable Host Loader tree and each plugin’s current lifecycle state.',
    'zh-CN': '查看稳定 Host 的 Loader 插件树与每个插件当前的生命周期状态。',
  },
  pluginInventorySearch: { en: 'Search plugins', 'zh-CN': '搜索插件' },
  pluginInventoryList: { en: 'Plugin list', 'zh-CN': '插件列表' },
  pluginInventoryReading: { en: 'Reading the Loader tree…', 'zh-CN': '正在读取 Loader 插件树…' },
  pluginInventoryLoadError: { en: 'The plugin inventory could not be loaded', 'zh-CN': '无法读取插件清单' },
  pluginInventoryEmpty: { en: 'No plugins found', 'zh-CN': '没有插件' },
  pluginInventoryEmptyDescription: {
    en: 'The current Host profile does not contain any non-group Loader entries.',
    'zh-CN': '当前 Host 配置没有非分组 Loader 条目。',
  },
  pluginInventoryNoResults: { en: 'No plugins match this search.', 'zh-CN': '没有匹配当前搜索的插件。' },
  pluginInventoryDisabled: { en: 'Disabled', 'zh-CN': '已停用' },
  pluginInventoryActive: { en: 'Mounted', 'zh-CN': '已挂载' },
  pluginInventoryFailed: { en: 'Failed', 'zh-CN': '加载失败' },
  pluginInventoryLoading: { en: 'Loading', 'zh-CN': '加载中' },
  pluginInventoryUnloading: { en: 'Unloading', 'zh-CN': '卸载中' },
  pluginInventoryPending: { en: 'Pending', 'zh-CN': '等待中' },
  pluginInventoryIdle: { en: 'Not mounted', 'zh-CN': '未挂载' },
  patchManagementTitle: { en: 'Harmony plugins and Patches', 'zh-CN': 'Harmony 插件与 Patch' },
  patchManagementDescription: {
    en: 'Reorder providers and individual Patches, inspect runtime results, then apply everything in one transaction.',
    'zh-CN': '调整插件与单个 Patch 的顺序、检查运行结果，再通过一次事务应用全部修改。',
  },
  patchManagementSearch: { en: 'Search plugins or Patches', 'zh-CN': '搜索插件或 Patch' },
  patchManagementNoResults: { en: 'No plugins or Patches match this search.', 'zh-CN': '没有匹配当前搜索的插件或 Patch。' },
  ...
  automaticPatchAction: { en: 'Create automatic CSS Patch', 'zh-CN': '创建自动 CSS Patch' },
  automaticPatchTitle: { en: 'Automatic CSS Patch', 'zh-CN': '自动 CSS Patch' },
  automaticPatchDescription: {
    en: 'Decorate the selected component without changing its call sites or props. Review every source match before writing.',
    'zh-CN': '在不修改调用点和 Props 的情况下装饰选中组件；写入前先检查所有源码命中。',
  },
  ...
  automaticPatchAgentPrompt: {
    en: 'Modify component {component} with the selected context. Apply CSS {property}: {value} without changing its existing call-site props, and preserve compatibility with other Harmony Patches.',
    'zh-CN': '请结合当前选区上下文修改组件 {component}，在不改变现有调用点 Props 的前提下应用 CSS {property}: {value}，并保持与其它 Harmony Patch 的可组合性。',
  },
  automaticPatchCreated: { en: 'Created {count} Component Patch(es) and reloaded Preview.', 'zh-CN': '已创建 {count} 个 Component Patch 并热重载 Preview。' },
