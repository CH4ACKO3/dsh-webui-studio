...
const messages = {
  ...
  profileCustomUnavailable: { en: 'The custom profile editor is not available yet. Choose the main DSH_HOME profile to continue.', 'zh-CN': '自定义配置编辑器尚未实现；请选择主 DSH_HOME 配置继续。' },
  profileMain: { en: 'Use the current main DSH_HOME profile', 'zh-CN': '使用当前主 DSH_HOME 配置' },
  profileCustom: { en: 'Custom profile (placeholder)', 'zh-CN': '自定义配置（占位）' },
  ...
  persistedDrafts: { en: 'Persisted Studio drafts', 'zh-CN': 'Studio 持久化草稿' },
  alreadyOpen: { en: 'Opened', 'zh-CN': '已打开' },
  open: { en: 'Open', 'zh-CN': '打开' },
  persistedDraftsDescription: { en: 'Drafts are stored in the Studio data directory. Closing a tab does not delete the plugin or stop its instance.', 'zh-CN': '草稿保存在 Studio 数据目录；关闭标签不会删除插件或停止实例。' },
  ...
  buildDescription: { en: 'Build the current Draft and load new plugin output without stopping Preview Host.', 'zh-CN': '构建当前 Draft，并在保留 Preview Host 的同时加载新插件产物。' },
