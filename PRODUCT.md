...
- Plugin Management reads the stable Host's public Harmony profile, stages plugin order and provider enablement together, and commits them through one transactional hot reload. Running Drafts keep their isolated profile snapshot until restarted from their selected source profile.
