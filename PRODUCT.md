...
- Draft labels are persisted independently from npm package names. Open Draft tabs persist locally and can be reopened from Plugin Management; closing a tab never stops or deletes its Draft. Unsaved Source changes block tab switching and closing until saved.
