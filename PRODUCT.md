...
- Plugin Management reads the stable Host's public Harmony profile and inspection, stages provider order, Patch execution order, provider/Patch enablement together, and commits them through one transactional hot reload. Running Drafts keep their isolated profile snapshot until restarted from their selected source profile.
